...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 10, description: 'Id de la empresa' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'juan@email.com', description: 'Email del usuario' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '1234567890', description: 'Documento de identidad' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateUserDto.prototype, "document", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 2, description: 'Id del rol' }),
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", Number)
