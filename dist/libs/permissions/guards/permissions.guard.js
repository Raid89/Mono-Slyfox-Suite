...
let PermissionsGuard = class PermissionsGuard {
    ...
    async canActivate(context) {
        const permissionId = this.reflector.get(permissions_decorator_1.PERMISSION_KEY, context.getHandler());
        if (!permissionId) {
            return true;
        }
        ...
        if (!authHeader || !authHeader.startsWith('Bearer ')) {
            throw new common_1.UnauthorizedException('Header de autorización no encontrado o formato incorrecto');
        }
